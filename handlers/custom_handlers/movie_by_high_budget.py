...
def search_movie_by_high_budget(message: Message):
    """
    Функция поиска с высоким бюджетом, которая уточняет у пользователя рейтинг фильма, его жанр и лимит выводимых фильмов.
    ...
    bot.send_message(
        ...
        f"Начинаем поиск фильмов с высоким бюджетом.\n\nКакой рейтинг у фильмов? (Например, 8-10)",
    ...
    def get_movie_limit(next_message: Message):
        ...
        try:
            print_movie_list(
                message,
                get_movies(
                    budget="1000000-9999999999", # В долларах
